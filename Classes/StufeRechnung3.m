...
- (void)viewDidLoad {
	...
	self.title = NSLocalizedString(@"Fahrausweis", nil);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	switch ([indexPath indexAtPosition:1]) {
		...
		case 2:
			...
			break;
		case 3:
			cell.textLabel.text = NSLocalizedString(@"Steuersatz (wenn nicht ermäßigt) oder Tarifentfernung", nil);
			break;
	}
