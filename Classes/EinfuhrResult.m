...
- (NSString*)composeResult {
	...
	[s appendString:@"Der Umsatz ist gemäß § 1 Abs. 1 Nr. 4 UStG steuerbar. "];
	[s appendString:@"Der Umsatz ist auch steuerpflichtig, da eine Steuerbefreiung "];
	[s appendString:@"nach § 5 UStG nicht greift.\n\nDie Bemessungsgrundlage richtet sich gemäß "];
	[s appendString:@"§ 11 Abs. 1 UStG nach dem Zollwert und beträgt "];
	...
	[s appendString:@" Prozent anzuwenden. Es ist ein Betrag in Höhe von "];
	...
	[s appendString:[self checkIfToAddEndingZero:s]];
	[s appendString:@" € als Einfuhrumsatzsteuer an den Zoll zu entrichten. In gleicher Höhe hat ein Unternehmer "];
	[s appendString:@"den Vorsteuerabzug."];
