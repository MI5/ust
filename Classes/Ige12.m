...
- (void)viewDidLoad {
	...
	self.title = NSLocalizedString(@"i.g.E. Neu-KFZ", nil);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	switch ([indexPath indexAtPosition:1]) {
		case 0:
			cell.textLabel.text = NSLocalizedString(@"Erwerb eines neuen KFZ...", nil);
			break;
		case 1:
			cell.textLabel.text = NSLocalizedString(@"...durch eine Privatperson...", nil);
			break;
		case 2:
