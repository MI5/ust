...
@implementation EinfuhrEntstehung
...
- (void)viewDidLoad {
	...
	self.title = NSLocalizedString(@"Entst. EUSt", nil);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	cell.textLabel.text = NSLocalizedString(@"Annahme der Zollanmeldung durch die Zollstelle.", nil);
