...
- (void)viewDidLoad {
	...
	self.title = NSLocalizedString(@"Antrag auf Istbest.", nil);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	switch ([indexPath indexAtPosition:1]) {
		...
		case 1:
			...
			break;
		case 2:
			cell.textLabel.text = NSLocalizedString(@"Freiberufler (Arzt, Anwalt, Steuerberater, Notar...)", nil);
			break;
	}
